    ...
    extends zUploadBaseObject
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->setFilefolder();
        $this->gdlog()->LogInfo($this->getFilefolder());
        // $this->getGDConfig()->gdlog()->LogInfo(dirname($this->getFilefolder()));
        $this->gdlog()->LogInfo($this->get_full_url().'/files/');
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => $this->getFilefolder(),
    ...
    protected function get_full_url() {
        gdlog()->LogInfoStartFUNCTION("get_full_url()");
        
        $this->gdlog()->LogInfo($_SESSION[ZGDConfigurations::getKeySessSiteConfigRoot()]);
        ...
        gdlog()->LogInfoEndFUNCTION("get_full_url()");
        return $url;
    }
