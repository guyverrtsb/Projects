...
$post_data = $POST->getPost(array("post_id" => $image_id, "userid" => $userId));
$post_deatil = $post_data['posts'];
//print_r($post_deatil); die;
$comment_data = $POST_COMMENT->PostComments(array("post_id" => $image_id, "userid" => $userId));
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="postDetails">             
                ...
                <section class="post_comments" id="post_comments">
                    <ul id="next_comment" >
                        <?php
