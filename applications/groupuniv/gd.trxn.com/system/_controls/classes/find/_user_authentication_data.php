    ...
    extends zAppBaseObject
{
    ...
    function findUserAuthenticationData_ByEmail($usersafety_useraccount_email)
    {
        ...
        $sqlstmnt = "SELECT ".
            ...
            $this->dbfas("usersafety_useraccount.uid, ".
                        ...
                        "usersafety_userprofile.cfg_region_uid, ".
                        "usersafety_userprofile.cfg_country_uid, ".
                        "usersafety_role.uid, ".
    ...
    function getCfgRegionUid() { return $this->getResult_RecordField($this->dbf("usersafety_userprofile.cfg_region_uid")); }
    function getCfgCountryUid() { return $this->getResult_RecordField($this->dbf("usersafety_userprofile.cfg_country_uid")); }
