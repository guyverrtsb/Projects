...

{
    ...
    function findConfigurationListfromGroupKey($group_key, $dbconfigkey = "GROUPYOU")
    {
    ...
    function findConfigurationfromSdesc($sdesc, $dbconfigkey = "GROUPYOU")
    {
    ...
    function findConfigurationfromUid($uid, $dbconfigkey = "GROUPYOU")
    {
