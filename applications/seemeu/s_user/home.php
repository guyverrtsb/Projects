...
?>
<?php zInc("/_controls/ui/templates/standard/head.php"); ?>
<!-- START - Content ================================================== -->
<div class="wrapper">
    <div class="box">
        <div class="row row-offcanvas row-offcanvas-left">
<!-- START - Left Navigation ================================================== -->
<?php zInc("/_controls/ui/templates/standard/left_navigation.php"); ?>
<!-- END - Left Navigation ================================================== -->
<!-- START - Main - Right Column ================================================== -->
            <div class="column col-sm-9 col-xs-11" id="main">
<!-- START - Top Navigation ================================================== -->
<?php zInc("/_controls/ui/templates/standard/top_navigation.php"); ?>
<!-- END - Top Navigation ================================================== -->
                <div class="padding">
...
<!-- START - Main - Left Column ================================================== -->
                            <div class="col-sm-5">
                                <div class="panel panel-default">
                                    ...
                                    <p><img src="https://lh3.googleusercontent.com/uFp_tsTJboUY7kue5XAsGA=s28" width="28px" height="28px"></p>
                                    </div>
                                </div>
...
<!-- END - Content ================================================== -->
                        ...
                        <div class="row" id="footer">    
                            ...
                            <div class="col-sm-6"><p><a href="#" class="pull-right">©Copyright 2013</a></p></div>
                        </div>
                        <hr>
...
<div id="postModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>Update Status</div>
...
<!-- END - Post Modal ================================================== -->
<!-- END - Content ================================================== -->
<?php zInc("/_controls/ui/templates/standard/foot.php"); ?>