...
zAppSysIntegration()->setDefaultPageTitle("Faculty - Login / Registraion")
?>
...
<?php zInc("/gd.trxn.com/_controls/ui/components/uimessageline.php"); ?>
    <div id="loginbox" class="row">
        ...
        <!-- Usertype hidden Box -->
        <input type="hidden" id="inputServiceControlKey" name="SERVICE_CONTROL_KEY" class="form-control" value="USERSAFETY-LOGIN_BY_EMAIL_FACULTY" required>
        <!-- Check Box -->
        <div class="checkbox">
            <label>
    ...
    <div id="signupbox" class="row" style="display:none;">
        ...
        <!-- Usertype hidden Box -->
        <input type="hidden" id="inputServiceControlKey" name="SERVICE_CONTROL_KEY" class="form-control" value="USERSAFETY-REGISTER_BY_EMAIL_FACULTY" required>
        <!-- Check Box -->
        <div class="checkbox">
