    ...
    extends AppSysBaseObject
{
    ...
    {
        zLog()->LogStartFUNCTION("loadObjects");
        $mr = "NA";
        ...
        zLog()->LogEndFUNCTION("loadObjects");
    }
    
    function assignObjectToGamer($gameraccount_email,
                                $object_sdesc)
    {
        zLog()->LogStartFUNCTION("assignObjectToGamer");
        $mr = "NA";
        ...
        $this->setSysReturnCode($mr);
        zLog()->LogEndFUNCTION("assignObjectToGamer");
    }
    ...
    {
        zLog()->LogStartFUNCTION("deleteObjects");
        $mr = "NA";
        ...
        $this->setSysReturnCode($mr);
        zLog()->LogEndFUNCTION("deleteObjects");
    }
}
?>