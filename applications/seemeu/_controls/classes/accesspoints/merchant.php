    ...
    extends AppSysBaseObject
{
    ...
    {
        zLog()->LogStartFUNCTION("createMerchantInfo");
        $mr = "NA";
        ...
        zLog()->LogEndFUNCTION("createMerchantInfo");
    }
    ...
    {
        zLog()->LogStartFUNCTION("deleteMerchantInfo");
        ...
        $this->setSysReturnCode($mr);
        zLog()->LogEndFUNCTION("deleteMerchantInfo");
    }
