...
<script src="s_user_account.js"></script>
<script>
</script>
</head>
<body>
...
{
    printf("<p class=\"message\" UIPAGERESSHOW=\"%s\" UIPAGERESCODE=\"%s\" UIPAGERESKEY=\"%s\" UIPAGERESMSG=\"%s\">%s</p>", gdconfig()->getKeySessUIPageRespMsgShow(), gdconfig()->getUIPageResponseCode(), gdconfig()->getUIPageResponseKey(), gdconfig()->getUIPageResponseMsg(), gdconfig()->getUIPageResponseMsg());
}
?>
<?php gdconfig()->cleanUIPageResponseData() ?>
        </div>
        <div id="left_column"><?php gdinc("/gd.trxn.com/_controls/ui/left_menu/s_menu.php") ?></div>
        <div id="workarea" dyncontentkey="SINGLE_USER_DATA" apppath="/gd.trxn.com">
