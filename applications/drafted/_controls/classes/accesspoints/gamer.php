    ...
    extends AppSysBaseObject
{
    ...
    function createGamerInfo($email,
                            ...
                            $avatarmimeuid = "")
    {
        zLog()->LogStart_AccessPointFunction("createGamerInfo");
        $mr = "NA";
        ...
        zLog()->LogEnd_AccessPointFunction("createGamerInfo");
    }
    
    function retrieveGamer($by, $val)
    {
        zLog()->LogStart_AccessPointFunction("retrieveGamer");
        $mr = "NA";
        ...
        $this->setSysReturnCode($mr);
        zLog()->LogEnd_AccessPointFunction("retrieveGamer");
    }
}
?>