    ...
    extends SysUtilities
{
    ...
    function setSysReturnStructure()
    {
        ...
        if(!$msgshowcaught)
            $this->setSysReturnUIShowmsg("TRUE");    
        if(!$msgcaught)
    ...
    /**
     * If message should be shown on UI
     */
    function setSysReturnUIShowmsg($showMsgUI)
    {
        $this->setSysReturnitem("RETURN_SHOW_MSG_UI", $showMsgUI);
    }
    
    function getSysReturnUIShowmsg()
    {
        return $this->getSysReturnitem("RETURN_SHOW_MSG_UI");
    }
    
    /**
     * This is the message for the return
     * for example "The Transaction has failed" 
     */
    function setSysReturnMsg($msg)
    {
     ...
     */
    function setSysReturnCode($code)
    {
