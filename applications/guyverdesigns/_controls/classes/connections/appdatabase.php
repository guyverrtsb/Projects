    ...
    extends ZGDDBConnection
{
    ...
    private function getConnectionVariable($db, $param)
    {
        ...
        $filename = strtolower($_SESSION['GUYVERDESIGNS_SERVER_ENVIRONMENT'])."_connections.xml";
        // gdlog()->LogDebug("Connections XML : {".$configroot.$filename);
        
        $xml = simplexml_load_file($configroot.$filename);
