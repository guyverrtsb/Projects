...
<?php setpagekey("RECRUITMENT_VIEW_OF_RESOURCE"); ?>
<!DOCTYPE HTML><!-- HTML 5 -->
</html>
<head>
...
<script src="s_recruiter_view_of_resource.js"></script>
<script>
</script>
</head>
<body>
...
<?php gdinc("/_controls/ui/header.php") ?>
    ...
    <div id="content_area">
        ...
        <div id="workarea">
            <div id="workarea_row_01" class="workframe"></div>
            <div id="workarea_row_02" class="workframe"></div>
            <div id="workarea_row_03" class="workframe"></div>
            <div id="workarea_row_04" class="workframe" dyncontentkey="REQUIREMENTS_FOR_RESOURCE" funcname="buildRequirementsTiles"></div>
        </div>
