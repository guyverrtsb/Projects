...
DROP TABLE IF EXISTS `match_usersafety_useraccount_to_crossappl_site`;
-- -----------------------------------------------------
...
DROP TABLE IF EXISTS `match_useraccount_to_userprofile`;
-- -----------------------------------------------------
...
DROP TABLE IF EXISTS `match_useraccount_to_openauth`;
-- -----------------------------------------------------
...
-- Table `userprofile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `seemeuusersafety`.`userprofile` (
  `lid` INT(11) NOT NULL AUTO_INCREMENT,
  `uid` VARCHAR(36) NOT NULL,
  `createddt` DATETIME NOT NULL,
  `changeddt` DATETIME NOT NULL,
