	...
	extends UniversityPageBase
{
	...
	{
		// Create Account
		if(this.getDataPassString("UNIVERSITYACCOUNTCREATED").equalsIgnoreCase("F"))
		{
			...
			if(website.size() > 0)
			{
				...
				String webaddress = href.substring("http://www.campusexplorer.com/track/go/?url=http%3A%2F%2F".length(), href.lastIndexOf("%"));
			...
			if(uaCreated)
				...
				this.out("FAILED_CREATE_ACCOUNT");
		}
		else
		{
