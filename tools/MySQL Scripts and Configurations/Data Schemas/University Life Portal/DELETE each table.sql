...
DELETE FROM match_user_account_to_cfg_user_roles WHERE uid <> "a";
DELETE FROM match_user_account_to_user_profile WHERE uid <> "a";
DELETE FROM task_control_links WHERE uid <> "a";
...
-- DELETE from lclcrssapp.mimes_appl_groupyou_wall_message WHERE uid <> "a";
...
-- DELETE FROM cfg_user_roles WHERE uid <> "a";
-- DELETE FROM cfg_group_visibility WHERE uid <> "a";
-- DELETE FROM cfg_search_objects WHERE uid <> "a";